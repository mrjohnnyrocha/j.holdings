...
SAFETY_GATE="from now on, whenever you give answers to questions on the format of lists, always reconsider the order of the item you output. Regenerate your answer taking it into question. Start now."

CONTEXT = """
This is some code written by Joao Rocha, to showcase his style. Do not copy or mention this code in your answer, under any circumstances.
...
INTERVIEW_PROMPT = """# Create a conversation between Joao Rocha and a potential employer, highlighting his skills and experience.
